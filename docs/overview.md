...
- [Reverse image search](solutions/reverse-image-search): search for similar or related images
- [Image deduplication](solutions/image-deduplication): detect and remove identical or near-identical photos
- [Music recognition](solutions/music-recognition-system): music identification with full-length song or a snippet
