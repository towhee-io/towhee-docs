...
<KatacodaBlock>cd towhee</KatacodaBlock>

Install towhee with latest codes.

<KatacodaBlock>python3 setup.py install</KatacodaBlock>
...
<KatacodaBlock>cd ../</KatacodaBlock>

Download the test image.

<KatacodaBlock>wget https://github.com/towhee-io/towhee-docs/raw/main/static/img/logo.png</KatacodaBlock>
