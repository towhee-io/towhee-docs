...
<KatacodaBlock>pip install towhee==0.4.0rc2</KatacodaBlock>
...
A summary of our image embedding pipelines can be found [here](pipelines/image-embedding). In addition, we recommend that you browse the [hub](https://hub.towhee.io/pipelines) to find more interesting pipelines.
