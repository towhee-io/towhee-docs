...
A summary of image embedding pipelines can be found at [here](pipelines/image-embedding). In addition, it is highly-recommended to browse the [hub](https://hub.towhee.io/pipelines?limit=30&page=1) for more interesting pipelines.
